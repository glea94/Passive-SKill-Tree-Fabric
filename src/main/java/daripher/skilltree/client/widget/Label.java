...
>>>>>>> Stashed changes
            ...
            // Fix préventif (même bug ARGB que ScreenHelper/ProgressBar/TextField) : 0xFFFFFF sans octet
            // alpha est traité comme totalement transparent par GuiGraphicsExtractor.text() (ARGB.alpha(color) == 0 => rien n'est dessiné).

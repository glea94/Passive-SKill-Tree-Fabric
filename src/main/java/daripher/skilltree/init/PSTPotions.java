...
public class PSTPotions {
    // Aligned 1.21.4: Direct registry mapping through BuiltInRegistries.POTION
    ...
    // Instantiates custom potions safely with registry-wrapped holders
    ...
    public static final RegistryObject<Potion> LIQUID_FIRE_2 = REGISTRY.register("liquid_fire_2",
            () -> new Potion("liquid_fire_2", new MobEffectInstance(wrapEffect(PSTMobEffects.LIQUID_FIRE.get()), 0, 1)));

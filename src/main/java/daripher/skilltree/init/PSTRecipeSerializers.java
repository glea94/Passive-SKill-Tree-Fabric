...
import daripher.skilltree.recipe.workbench.WorkbenchMaceRecipe;
...
public class PSTRecipeSerializers {
    ...
    public static final RegistryObject<RecipeSerializer<WorkbenchMaceRecipe>> WORKBENCH_MACE = REGISTRY.register("workbench_mace", () -> WorkbenchMaceRecipe.Serializer.INSTANCE);
}
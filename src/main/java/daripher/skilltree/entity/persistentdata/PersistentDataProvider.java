...
=======
    // Aligned 1.21.4: Using ResourceLocation.fromNamespaceAndPath is standard and type-safe for component capabilities
    public static final ComponentKey<IPersistentData> KEY = ComponentRegistryV3.INSTANCE.getOrCreate(
            ResourceLocation.fromNamespaceAndPath(SkillTreeMod.MOD_ID, "persistent_data"), IPersistentData.class);
>>>>>>> Stashed changes
